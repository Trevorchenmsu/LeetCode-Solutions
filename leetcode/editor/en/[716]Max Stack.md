...
<p>&nbsp;</p>
<strong>Follow up:</strong> Could you come up with a solution that supports <code>O(1)</code> for each <code>top</code> call and <code>O(logn)</code> for each other call?&nbsp;<div><div>Related Topics</div><div><li>Design</li></div></div>\n<div><li>👍 927</li><li>👎 225</li></div>